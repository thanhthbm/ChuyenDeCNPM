...
\begin{figure}[H]
    ...
    \caption{Minh họa trường hợp turbo-shift trong thuật toán Turbo-BM}
    \label{fig:turbo-bm-turbo-shift}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Minh họa trường hợp dịch chuyển lớn hơn turbo-shift}
    \label{fig:turbo-bm-shift-bound}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Kết quả tiền xử lý của thuật toán Turbo-BM}
    \label{fig:turbo-bm-preprocess-1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Images/2026-05-18-09-33-21.png}
    \caption{Bảng bmBc và bmGs trong thuật toán Turbo-BM}
    \label{fig:turbo-bm-preprocess-2}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 1 trong quá trình thực hiện thuật toán Turbo-BM}
    \label{fig:turbo-bm-step-1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 2 trong quá trình thực hiện thuật toán Turbo-BM}
    \label{fig:turbo-bm-step-2}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 3 trong quá trình thực hiện thuật toán Turbo-BM}
    \label{fig:turbo-bm-step-3}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 4 trong quá trình thực hiện thuật toán Turbo-BM}
    \label{fig:turbo-bm-step-4}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 5 trong quá trình thực hiện thuật toán Turbo-BM}
    \label{fig:turbo-bm-step-5}
\end{figure}
