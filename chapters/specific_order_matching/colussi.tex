...
\begin{figure}[H]
    ...
    \caption{Minh họa phép dịch chuyển khi mismatch ở nohole trong thuật toán Colussi}
...
\begin{figure}[H]
    ...
    \caption{Minh họa phép dịch chuyển khi mismatch ở hole trong thuật toán Colussi}
    \label{fig:colussi-hole-shift}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Kết quả tiền xử lý của thuật toán Colussi}
    \label{fig:colussi-test-preprocess}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 1 trong quá trình thực hiện thuật toán Colussi}
    \label{fig:colussi-test-step-1}
\end{figure}
Lần 2:
...
\begin{figure}[H]
    ...
    \caption{Bước 2 trong quá trình thực hiện thuật toán Colussi}
    \label{fig:colussi-test-step-2}
\end{figure}
Lần 3:
...
\begin{figure}[H]
    ...
    \caption{Bước 3 trong quá trình thực hiện thuật toán Colussi}
    \label{fig:colussi-test-step-3}
\end{figure}
Lần 4:
...
\begin{figure}[H]
    ...
    \caption{Bước 4 trong quá trình thực hiện thuật toán Colussi}
    \label{fig:colussi-test-step-4}
\end{figure}
Lần 5:
...
\begin{figure}[H]
    ...
    \caption{Bước 5 trong quá trình thực hiện thuật toán Colussi}
    \label{fig:colussi-test-step-5}
\end{figure}
Lần 6:
...
\begin{figure}[H]
    ...
    \caption{Bước 6 trong quá trình thực hiện thuật toán Colussi}
    \label{fig:colussi-test-step-6}
\end{figure}
Lần 7:
...
\begin{figure}[H]
    ...
    \caption{Bước 7 trong quá trình thực hiện thuật toán Colussi}
    \label{fig:colussi-test-step-7}
\end{figure}
Lần 8:
...
\begin{figure}[H]
    ...
    \caption{Bước 8 trong quá trình thực hiện thuật toán Colussi}
    \label{fig:colussi-test-step-8}
\end{figure}
