...
\begin{figure}[H]
    ...
    \caption{Bảng ký tự sai (bad-character) của thuật toán Boyer-Moore}
    \label{fig:boyer-moore-bad-character-table}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Minh họa quá trình so khớp của thuật toán Boyer-Moore}
    \label{fig:boyer-moore-search}
\end{figure}
