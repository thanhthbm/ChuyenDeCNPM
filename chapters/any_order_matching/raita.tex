...
\begin{figure}[H]
    ...
    \caption{Kết quả tiền xử lý bảng bmBc của thuật toán Raita}
    \label{fig:raita-preprocess}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 1 trong quá trình thực hiện thuật toán Raita}
    \label{fig:raita-step-1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 2 trong quá trình thực hiện thuật toán Raita}
    \label{fig:raita-step-2}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 3 trong quá trình thực hiện thuật toán Raita}
    \label{fig:raita-step-3}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 4 trong quá trình thực hiện thuật toán Raita}
    \label{fig:raita-step-4}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 5 trong quá trình thực hiện thuật toán Raita}
    \label{fig:raita-step-5}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 6 trong quá trình thực hiện thuật toán Raita}
    \label{fig:raita-step-6}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 7 trong quá trình thực hiện thuật toán Raita}
    \label{fig:raita-step-7}
\end{figure}
