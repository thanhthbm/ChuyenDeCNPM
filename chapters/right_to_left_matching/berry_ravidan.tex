...
\begin{figure}[H]
    ...
    \caption{Kết quả tiền xử lý bảng brBc của thuật toán Berry-Ravindran}
    \label{fig:berry-ravindran-preprocess}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 1 trong quá trình thực hiện thuật toán Berry-Ravindran}
    \label{fig:berry-ravindran-step-1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 2 trong quá trình thực hiện thuật toán Berry-Ravindran}
    \label{fig:berry-ravindran-step-2}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 3 trong quá trình thực hiện thuật toán Berry-Ravindran}
    \label{fig:berry-ravindran-step-3}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 4 trong quá trình thực hiện thuật toán Berry-Ravindran}
    \label{fig:berry-ravindran-step-4}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 5 trong quá trình thực hiện thuật toán Berry-Ravindran}
    \label{fig:berry-ravindran-step-5}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 6 trong quá trình thực hiện thuật toán Berry-Ravindran}
    \label{fig:berry-ravindran-step-6}
\end{figure}
