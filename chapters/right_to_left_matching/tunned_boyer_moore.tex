...
\begin{figure}[H]
    ...
    \caption{Kết quả tiền xử lý bảng bmBc của thuật toán Tuned Boyer-Moore}
    \label{fig:tuned-boyer-moore-preprocess}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 1 trong quá trình thực hiện thuật toán Tuned Boyer-Moore}
    \label{fig:tuned-boyer-moore-step-1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 2 trong quá trình thực hiện thuật toán Tuned Boyer-Moore}
    \label{fig:tuned-boyer-moore-step-2}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 3 trong quá trình thực hiện thuật toán Tuned Boyer-Moore}
    \label{fig:tuned-boyer-moore-step-3}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 4 trong quá trình thực hiện thuật toán Tuned Boyer-Moore}
    \label{fig:tuned-boyer-moore-step-4}
\end{figure}
