...
\begin{figure}[H]
    ...
    \caption{Kết quả tiền xử lý bảng qsBc của thuật toán Quick Search}
    \label{fig:quick-search-preprocess}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 1 trong quá trình thực hiện thuật toán Quick Search}
    \label{fig:quick-search-step-1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 2 trong quá trình thực hiện thuật toán Quick Search}
    \label{fig:quick-search-step-2}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 3 trong quá trình thực hiện thuật toán Quick Search}
    \label{fig:quick-search-step-3}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 4 trong quá trình thực hiện thuật toán Quick Search}
    \label{fig:quick-search-step-4}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bước 5 trong quá trình thực hiện thuật toán Quick Search}
    \label{fig:quick-search-step-5}
\end{figure}
