...
\begin{figure}[H]
    ...
    \caption{Minh họa vị trí mismatch trong thuật toán KMP}
    \label{fig:kmp-mismatch}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Bảng LPS trong thuật toán KMP}
    \label{fig:kmp-lps-table}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Minh họa quá trình tìm kiếm của thuật toán KMP}
    \label{fig:kmp-search}
\end{figure}
